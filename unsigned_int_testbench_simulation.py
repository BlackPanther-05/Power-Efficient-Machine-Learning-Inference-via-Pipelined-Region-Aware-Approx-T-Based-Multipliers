...
RESULT_DIR = ROOT / "Simulation_Results" / "base" / "Unsigned_int"

SIMULATIONS = [
    ("tb/Unsigned_int/tb_unsigned_int_L0.v", "test_Unsigned_int_L0", "Unsigned_int_L0.csv"),
    ("tb/Unsigned_int/tb_unsigned_int_L1.v", "test_Unsigned_int_L1", "Unsigned_int_L1.csv"),
    ("tb/Unsigned_int/tb_unsigned_int_L2.v", "test_Unsigned_int_L2", "Unsigned_int_L2.csv"),
]

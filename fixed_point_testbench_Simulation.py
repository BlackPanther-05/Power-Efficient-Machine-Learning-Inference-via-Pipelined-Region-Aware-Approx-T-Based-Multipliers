...
RESULT_DIR = ROOT / "Simulation_Results" / "Fixed_point"

SIMULATIONS = [
    ("tb/Fixed_point/tb_fixed_point_L0.v", "test_Fixed_point_L0", "Fixed_point_L0.csv"),
    ("tb/Fixed_point/tb_fixed_point_L1.v", "test_Fixed_point_L1", "Fixed_point_L1.csv"),
    ("tb/Fixed_point/tb_fixed_point_L2.v", "test_Fixed_point_L2", "Fixed_point_L2.csv"),
]

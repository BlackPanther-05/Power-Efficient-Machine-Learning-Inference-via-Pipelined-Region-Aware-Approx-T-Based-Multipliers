...
module tb_signed_int_L0_L1_L2();
    ...
    initial begin : MAIN_TEST
        ...
        $fwrite(log_file, "SIGNED INTEGER TESTBENCH - RTL_proposed_2\n");
        $fwrite(log_file, "=============================================\n\n");
    ...
    // Instantiate the Approx-T multiplier (RTL_proposed_2 - non-pipelined)
    approx_t uut (
        .clk(clk),
        .reset_n(rst_n),
        .a(a),
    ...
    initial begin
        ...
        // Write summary file
        $fwrite(summary_file, "═════════════════════════════════════════════\n");
        $fwrite(summary_file, "SIGNED INTEGER TEST SUMMARY - RTL_proposed_2\n");
        $fwrite(summary_file, "═════════════════════════════════════════════\n");
        ...
        $display("\n");
        $display("════════════════════════════════════════════════════════════════");
        $display("SIGNED INTEGER TEST COMPLETE (RTL_proposed_2 Non-Pipelined)");
        $display("════════════════════════════════════════════════════════════════");

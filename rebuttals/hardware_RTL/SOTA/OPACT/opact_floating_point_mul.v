//============================================================================
// OPACT [5] — Floating Point Multiplier Wrapper (FP32)
//============================================================================

module opact_floating_point_mul(
    input  [31:0] A,
    input  [31:0] B,
    ...
    // Use 24-bit OPACT core for mantissa multiplication (1.mantissa × 1.mantissa)
    wire [47:0] mantissa_product;
    opact_mul_core #(24) m_opact_core(
        .A({1'b1, mantissa_a}),
        .B({1'b1, mantissa_b}),
